...
2. **Sorunu yeniden üret veya sınırla**
...
1. **Belirti**
2. **Olası nedenler** (öncelik sıralı)
3. **Kanıt**
4. **Kök neden** veya en güçlü doğrulanmış hipotez
5. **Uygulanan düzeltme**
6. **Geçici mi kalıcı mı?**
7. **Doğrulama**
...
- Docker tabanlı akışlarda gerektiğinde container logları ve servis sağlığını kontrol et.
