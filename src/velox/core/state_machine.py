...
_TRANSITIONS: dict[tuple[ConversationState, str], ConversationState] = {
    ...
    (ConversationState.INTENT_DETECTED, "menu_inquiry"): ConversationState.NEEDS_VERIFICATION,
    (ConversationState.INTENT_DETECTED, "room_service_order"): ConversationState.NEEDS_VERIFICATION,
