...
PERMISSION_CATALOG: dict[str, PermissionDefinition] = {
    ...
    "response_reviews:read": PermissionDefinition(
        key="response_reviews:read",
        group="conversation",
        label="Yanıt raporlarını görüntüleme",
        description="Operasyon masasından raporlanan AI/sistem yanıtlarını ve inceleme geçmişini görüntüler.",
    ),
    "response_reviews:write": PermissionDefinition(
        key="response_reviews:write",
        group="conversation",
        label="Yanıt raporlarını işleme",
        description="Yanıtları raporlar, doğru/yanlış sınıflandırır ve feedback dosyalarına aktarır.",
        is_sensitive=True,
    ),
...
ROLE_PERMISSIONS: dict[Role, set[str]] = {
    Role.ADMIN: {
        ...
        "hotels:write",
        "conversations:read",
        "response_reviews:read",
        "response_reviews:write",
        "holds:read",
        "holds:approve",
        "holds:reject",
        "restaurant_ai:read",
