...
class RiskFlag(StrEnum):
    ...
    # L1 — Soft
    PHYSICAL_OPERATION_REQUEST = "PHYSICAL_OPERATION_REQUEST"
    MENU_HALLUCINATION_RISK = "MENU_HALLUCINATION_RISK"
...
STARTUP_RETRY_BACKOFF_SECONDS = [1, 3, 5]
STARTUP_DEPENDENCY_TIMEOUT_SECONDS = 5.0
