...
- HTML tasarim dili: Kassandra Oludeniz logo/letterhead hissiyle uyumlu, A4 dikey, premium sade, fume-beyaz-siyaha yakin metinlerle, ince cift cerceveli, dekoratif koseli, merkez logo kilitli, numarali bolum basliklari ve cizgi-dolgulu form alanlari olan belge gorunumu kullanilir; kutulu kart/grid tasarim kullanilmaz.
